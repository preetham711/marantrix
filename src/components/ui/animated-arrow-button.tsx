...
export const AnimatedButton = ({ text = "Marantrix" }) => {
  // Define dot indices for the two icon variants
    ...
    <a href="#" className="button04 w-inline-block">
      ...
      <span data-text={text} className="button04_inner">
        ...
        <span className="button04_icon-wrap">
          <span style={{ '--index-parent': 0 } as React.CSSProperties} className="button04_icon">
          ...
          <span style={{ '--index-parent': 1 } as React.CSSProperties} className="button04_icon is-arrow">
